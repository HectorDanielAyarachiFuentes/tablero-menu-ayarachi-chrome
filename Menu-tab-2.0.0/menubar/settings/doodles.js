 ...
 */
export async function loadDoodles() {
...
export async function handleDoodleSelection(doodleId) {
  // When selecting a doodle, clear other background settings to ensure it takes priority
  await saveAndSyncSetting({
    doodle: doodleId,
    activePremiumTheme: null,  // Clear premium theme
    bgUrl: null,               // Clear URL background
    bgData: null,              // Clear local image background
    gradient: null             // Clear gradient
  });
